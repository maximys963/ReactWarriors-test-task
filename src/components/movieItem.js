            ...
            <div className="card" >
               ...
               <h5 className="card-title ">{this.props.title}</h5>
                <div className="card-body row">
                    ...
                    <div className="col-md-6 align-self-center" > <a href="#" className="btn btn-secondary" onClick={() => {this.props.chooseItem(this.props.vote, this.props.title)}}>Will watch</a></div>
                </div>
            </div>
        );
    }
